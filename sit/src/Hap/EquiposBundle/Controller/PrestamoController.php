...
use Hap\EquiposBundle\Form\PrestamoType;
use Hap\EquiposBundle\Form\PrestamoFilterType;
...
class PrestamoController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('HapEquiposBundle:Prestamo')->createQueryBuilder('e');
    ...
    */
     ...
     *
     * @Route("/", name="prestamo_create")
     * @Method("POST")
     * @Template("HapEquiposBundle:Prestamo:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HapEquiposBundle:Prestamo')->find($id);
     ...
     *
     * @Route("/{id}/edit", name="prestamo_edit")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}", name="prestamo_update")
     * @Method("PUT")
     * @Template("HapEquiposBundle:Prestamo:edit.html.twig")
     */
