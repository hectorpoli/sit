...
use Hap\EquiposBundle\Entity\Marca;
use Hap\EquiposBundle\Form\MarcaType;
use Hap\EquiposBundle\Form\MarcaFilterType;
...
class MarcaController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $filterForm = $this->createForm(new MarcaFilterType());
        $em = $this->getDoctrine()->getManager();
        $queryBuilder = $em->getRepository('HapEquiposBundle:Marca')->createQueryBuilder('e');

        // Reset filter
        if ($request->get('filter_action') == 'reset') {
            $session->remove('MarcaControllerFilter');
        }
        ...
        if ($request->get('filter_action') == 'filter') {
            ...
            if ($filterForm->isValid()) {
                ...
                $session->set('MarcaControllerFilter', $filterData);
            }
        } else {
            // Get filter from session
            if ($session->has('MarcaControllerFilter')) {
                $filterData = $session->get('MarcaControllerFilter');
                $filterForm = $this->createForm(new MarcaFilterType(), $filterData);
                $this->get('lexik_form_filter.query_builder_updater')->addFilterConditions($filterForm, $queryBuilder);
            }
        }
    ...
    */
    protected function paginator($queryBuilder)
    {
        ...
        {
            return $me->generateUrl('marca', array('page' => $page));
        };
     ...
     * @Method("POST")
     * @Template("HapEquiposBundle:Marca:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HapEquiposBundle:Marca')->find($id);
     ...
     * @Method("PUT")
     * @Template("HapEquiposBundle:Marca:edit.html.twig")
     */
