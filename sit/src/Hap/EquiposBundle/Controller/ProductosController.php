...
use Hap\EquiposBundle\Form\ProductosType;
use Hap\EquiposBundle\Form\ProductosFilterType;
...
class ProductosController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $filterForm = $this->createForm(new ProductosFilterType());
        $em = $this->getDoctrine()->getManager();
        $queryBuilder = $em->getRepository('HapEquiposBundle:Productos')->createQueryBuilder('e');
        ...
        if ($request->get('filter_action') == 'filter') {
            ...
            if ($session->has('ProductosControllerFilter')) {
                ...
                $filterForm = $this->createForm(new ProductosFilterType(), $filterData);
                $this->get('lexik_form_filter.query_builder_updater')->addFilterConditions($filterForm, $queryBuilder);
            }
        }
    ...
    */
    protected function paginator($queryBuilder)
    {
        ...
        {
            return $me->generateUrl('productos', array('page' => $page));
        };
     ...
     * @Method("POST")
     * @Template("HapEquiposBundle:Productos:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HapEquiposBundle:Productos')->find($id);
     ...
     * @Method("PUT")
     * @Template("HapEquiposBundle:Productos:edit.html.twig")
     */
